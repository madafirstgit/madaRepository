...
public class HttpUtil {
    ...
    public static String sendGet(String url, Map params) {
        ...
        try {
            ...
            connection.setRequestProperty("chartset", "GBK");
            connection.setRequestProperty("contentType", "text/html; charset=gbk");
            // 建立实际的连接
            connection.connect();
            // 获取所有响应头字段
     ...
     * @return 所代表远程资源的响应结果
     */
    public synchronized static String sendPost(String url, Map map) {
