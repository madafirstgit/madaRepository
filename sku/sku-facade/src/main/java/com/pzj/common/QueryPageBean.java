...
public class QueryPageBean implements Serializable {
    ...
    public QueryPageBean(long totalCount, QueryPageModel pager) {
    ...
    public String toString() {
        ...
        buff.append("当前Page对象信息如下").append("\n").append("分页索引的数组：" + sf).append("\n")
            .append("当前分页索引:" + this.getStartIndex()).append("\n")
            .append("总结果数：" + this.getTotalCount()).append("\n")
            .append("下一页索引:" + this.getNextIndex()).append("\n")
            .append("上一页索引:" + this.getPreviousIndex()).append("\n")
            .append("当前页码数：" + this.getCurrentPage()).append("\n")
