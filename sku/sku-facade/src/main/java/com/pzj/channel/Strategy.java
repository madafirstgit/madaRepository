...
public class Strategy implements MapObject<String,Strategy>, Serializable {
    /**
     * 
     */
     ...
     * 返利规则
     */
    private List<RebateStrategy> rebateStrategyList;
    ...
    public List<RebateStrategy> getRebateStrategyList() {
        return rebateStrategyList;
    }

    public void setRebateStrategyList(List<RebateStrategy> rebateStrategyList) {
