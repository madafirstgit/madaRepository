...
public class Page<T> implements java.io.Serializable{
	...
	private int pageNumberBegin;	// 数字分页开始
	private int pageNumberEnd;		// 数字分页结束
...
//	}
	...
	public void setLength(int length) {
		pageNumberBegin = Math.max(1, pageNo - length /2);
		pageNumberEnd = Math.min(pageNumberBegin + (length - 1), getTotalPage());
		this.length = length;
	}

	public int getPageNumberBegin() {
		return pageNumberBegin;
	}

	public void setPageNumberBegin(int pageNumberBegin) {
		this.pageNumberBegin = pageNumberBegin;
	}
