...
import com.pzj.base.common.objectDict.impl.BaseObjectDictRelationServiceImpl;
...
public abstract class BaseUserServiceImpl<T extends BaseEntity, E extends BaseUserMapper<T>>
		extends BaseObjectDictRelationServiceImpl<T, E> implements IBaseUserService<T> {
