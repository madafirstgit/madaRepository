...
public class LabelVo extends BaseVO implements Serializable {
    ...
    public static void validDataAll(LabelVo LabelVo) throws ServiceException {
        validData(LabelVo);
        checkLength(LabelVo.getName(), 100, "LabelVo.Name超过最大长度，最大为100");
        checkLength(LabelVo.getCreateBy(), 64, "LabelVo.CreateBy超过最大长度，最大为64");
        checkLength(LabelVo.getUpdateBy(), 64, "LabelVo.UpdateBy超过最大长度，最大为64");
        checkLength(LabelVo.getRemarks(), 255, "LabelVo.Remarks超过最大长度，最大为255");
    }
