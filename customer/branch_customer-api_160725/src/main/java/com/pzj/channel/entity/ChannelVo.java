...
public class ChannelVo extends BaseVO implements Serializable {
     ...
     * @return slist 政策集合
     */
    public List<StrategyVo> getSlist() {
        return slist;
    }
     ...
     *            政策集合
     */
    public void setSlist(List<StrategyVo> slist) {
        this.slist = slist;
    }
	...
	public static SysChannel changeTSysBean(ChannelVo vo) throws Exception {
        if (vo == null) {
            return null;
        }
    ...
    public static void validDataAll(ChannelVo vo) throws ServiceException {
        validData(vo);
