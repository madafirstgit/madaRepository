...
public class customerTest {
    ...
    @Test
    public void saveCustomerAndAuth1() throws Exception {
        Customer customer = new Customer();
        customer.setId(2216619736563739L);
        customer.setName("wefewf");
    ...
    public void saveCustomerAndAuth2() throws Exception {
        Customer customer = new Customer();
        customer.setId(2215520224936638L);
        customer.setSupplierId(344L);
    ...
    public void saveCustomerPassword() throws Exception {
        Customer customer = new Customer();
        customer.setId(2215520224936679L);
        customer.setName("测试用户");
        customer.setLoginName("abcdefghijkl");
        customer.setLoginPasswd("123456");
    ...
    public void findCustomerPageByParams() throws Exception {
        Customer customer = new Customer();
        // customer.setId(48L);
        PageList<Customer> customerlist = customerService.findCustomerPageByParams(1, 10, customer);
        assertNotNull(customerlist);
        for (int i = 0; i < 1; i++) {
            System.out.println(">>>>findCustomerByParams is : " + customerlist.get(i).getName());
        }
    ...
    public void login() throws Exception {
        Customer customer = customerService.login("130623198112302111", "123456");
        assertNotNull(customer);
    ...
    public void findCustomerScenicPageByParams() throws Exception {
        ...
        Date startDate = sdf.parse("2016-4-1");
        Date endDate = sdf.parse("2016-4-21");
        ...
        Customer customerParam = new Customer();
        customerParam.setId(2216619741563726L);
//        customerParam.setDirect(true);
//        customerParam.setDirectTime(startDate);
//        customerParam.setDirectTimeEnd(endDate);

        PageList<Customer> pageList = customerService.findCustomerScenicPageByParams(page, customerParam);
        assertNotNull(pageList);

        List<Customer> resultList = pageList.getResultList();
        assertNotNull(resultList);

        System.out.println(resultList.size());

        for (Customer customer : resultList){
            List<Long> scenicList = customer.getScenicList();

            assertNotNull(scenicList);
        }
    }
}
