...
public class Department extends CommonEntity implements Serializable {
    ...
    public static void validDataAll(Department department)
        ...
        checkLength(department.getParentId(), 64,
                "Department.ParentId超过最大长度，最大为64");
        checkLength(department.getParentIds(), 1000,
                "Department.ParentIds超过最大长度，最大为1000");
        checkLength(department.getAreaId(), 64, "Department.AreaId超过最大长度，最大为64");
        checkLength(department.getCode(), 100, "Department.Code超过最大长度，最大为100");
        checkLength(department.getName(), 100, "Department.Name超过最大长度，最大为100");
        checkLength(department.getType(), 1, "Department.DelFlag超过最大长度，最大为1");
        checkLength(department.getGrade(), 1, "Department.DelFlag超过最大长度，最大为1");
        checkLength(department.getAddress(), 255,
                "Department.DelFlag超过最大长度，最大为255");
        checkLength(department.getZipCode(), 100,
                "Department.DelFlag超过最大长度，最大为100");
        checkLength(department.getMaster(), 100,
                "Department.DelFlag超过最大长度，最大为100");
        checkLength(department.getPhone(), 200,
                "Department.DelFlag超过最大长度，最大为200");
        checkLength(department.getFax(), 200, "Department.DelFlag超过最大长度，最大为200");
        checkLength(department.getEmail(), 200,
                "Department.DelFlag超过最大长度，最大为200");
        checkLength(department.getCreateBy(), 64,
                "Department.DelFlag超过最大长度，最大为64");
        checkLength(department.getUpdateBy(), 64,
                "Department.DelFlag超过最大长度，最大为64");
        checkLength(department.getRemarks(), 255,
                "Department.DelFlag超过最大长度，最大为255");
        checkLength(department.getDelFlag(), 1, "Department.DelFlag超过最大长度，最大为1");
    }
