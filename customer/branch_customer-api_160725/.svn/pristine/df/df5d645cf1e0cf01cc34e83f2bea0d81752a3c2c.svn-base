...
public class Menu extends CommonEntity implements Serializable {
    ...
    public static void validDataAll(Menu menu) throws ServiceException {
        ...
        checkLength(menu.getName(), 100, "Menu.Name超过最大长度，最大为100");
        checkLength(menu.getHref(), 255, "Menu.Name超过最大长度，最大为255");
        checkLength(menu.getParentId(), 64, "Menu.Name超过最大长度，最大为64");
        checkLength(menu.getParentIds(), 2000, "Menu.Name超过最大长度，最大为2000");
        checkLength(menu.getTarget(), 20, "Menu.Name超过最大长度，最大为20");
        checkLength(menu.getIcon(), 100, "Menu.Name超过最大长度，最大为100");
        checkLength(menu.getIsShow(), 1, "Menu.Name超过最大长度，最大为1");
        checkLength(menu.getIsActiviti(), 1, "Menu.Name超过最大长度，最大为1");
        checkLength(menu.getPermission(), 200, "Menu.Name超过最大长度，最大为200");
        checkLength(menu.getCreateBy(), 64, "Menu.Name超过最大长度，最大为64");
        checkLength(menu.getUpdateBy(), 64, "Menu.Name超过最大长度，最大为64");
        checkLength(menu.getRemarks(), 255, "Menu.Name超过最大长度，最大为255");
        checkLength(menu.getDelFlag(), 1, "Menu.Name超过最大长度，最大为1");
        checkLength(menu.getPosition(), 255, "Menu.Name超过最大长度，最大为255");
        checkLength(menu.getStyle(), 255, "Menu.Name超过最大长度，最大为255");
    }
