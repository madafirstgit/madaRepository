...
public class SysUserRelation extends BaseEntity implements Serializable {
    ...
    public String toString() {
        ...
        strBuff.append("relType:").append(this.getRelType()).append(",");
        strBuff.append("userName:").append(this.getUserName()).append(",");
        strBuff.append("relUserName:").append(this.getRelUserName());
        strBuff.append("}");
