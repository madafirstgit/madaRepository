...
public class SysChannel extends BaseEntity {
    ...
    public String toString() {
        return "SysChannel [name=" + name + ", channelPrincipal=" + channelPrincipal + ", city="
               + city + ", county=" + county + ", province=" + province + ", spell=" + spell
               + ", remark=" + remark + ", channelType=" + channelType + ", channelCategory="
               + channelCategory + ", delFlag=" + delFlag + ", sort=" + sort + ", createDate="
               + createDate + ", updateDate=" + updateDate + ", updateBy=" + updateBy
               + ", createBy=" + createBy + ", dataSource=" + dataSource + ", supplierId="
               + supplierId + "]";
    }
